 ...
 * 
 * Used for testing the EnergisFees Contract, reduce the unit duration. This has no Period Cycle
 *
 * (c) Philip Louw / Zero Carbon Project 2018. The MIT Licence.
 */
contract PeriodUtilNoCycleMock is PeriodUtil {
  
    // High level each week is 10 seconds
    uint256 public constant SECONDS_PER_WEEK = 10;  
    // High level each year is 10 seconds (Units) * 10 (Units per Period) = 100 seconds
    uint256 public constant WEEKS_PER_PERIOD = 10;
